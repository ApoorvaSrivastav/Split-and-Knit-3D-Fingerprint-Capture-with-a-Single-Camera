The folder contains the code for Split and Knit algorithm. The code is a MATLAB pipeline. The code covers the complete pipeline from mask generation to 3D fingerprint knitting.
